	...
	return (
		...
		>
			<div className="food-quiz__meal-times">
				<div
					className="food-quiz__meal"
					data-time="breakfast"
					data-title={ __( 'Breakfast', 'planet4-child-theme-switzerland' ) }
			...
			<div className="food-quiz__result">
				...
				<div className="food-quiz__result-output">
					<div className="error-message">{ __( 'Please select at least one of each meal.', 'planet4-child-theme-switzerland' ) }</div>
					<div className="result-scale"></div>
					<InnerBlocks.Content />
				</div>
			</div>
		</div>
