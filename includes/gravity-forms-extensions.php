 ...
 * @return mixed
 */
function gpch_client_side_gravityforms_prefill( $form ) {
	...
	wp_enqueue_script( 'gpch-gf-client-side',
		get_stylesheet_directory_uri() . '/js/gravityforms-client-side.js',
		array(),
		filemtime( get_stylesheet_directory() . '/js/gravityforms-client-side.js' ),
		true );

	wp_localize_script( 'gpch-gf-client-side', 'gpchGfClientSideConfig', $gf_fronted_config );
